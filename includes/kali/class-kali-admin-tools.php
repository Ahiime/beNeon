...
class Kali_Admin_Tools {
	 ...
	 *
	 * @param string $name This is the post type name.
	 * @param string $slug This is the post type slug.
	 * @param string $desc This is the descriptions of the post type.
	 * @return void
	 */
	...
	/**
	 * Get request fields from options.
	 *
	 * @param array $options Request options.
	 * @return mixed The html field.
	 */
	 ...
	 *
	 * @param array $repeatable_field_settings The fields settings.
	 * @param array $repeatable_fields_data This is the field data.
	 * @return void Display the html fields.
	 */
	 ...
	 * @return false|string[]
	 */
	public static function explode_x( $delimiters, $str ) {
		return explode( chr( 1 ), str_replace( $delimiters, chr( 1 ), $str ) );
	}
	...
	/**
	 * Display a media like image or video.
	 *
	 * @param string $url This is the media url.
	 * @return void Display an html code.
	 */
	public static function display_media( $url ) {
		$extension = pathinfo( $url, PATHINFO_EXTENSION );

		if ( preg_match( '/^jpg|png|webp|jpeg|gif$/i', $extension ) ) {
			echo wp_kses_post( '<img src="' . $url . '" alt="Image">' );
		} elseif ( preg_match( '/^mp4|webm|ogg$/i', $extension ) ) {
			echo wp_kses_post( '<video width="40" height="40" src="' . $url . '" type="video/' . $extension . '"></video>' );
		} else {
			echo esc_html( '' );
		}
	}

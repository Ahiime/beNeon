...
class Beneon {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Beneon_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'BENEON_VERSION' ) ) {
			$this->version = BENEON_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'beneon';
	 ...
	 *
	 * - Beneon_Loader. Orchestrates the hooks of the plugin.
	 * - Beneon_i18n. Defines internationalization functionality.
	 * - Beneon_Admin. Defines all hooks for the admin area.
	 * - Beneon_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Beneon_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Beneon_Loader    Orchestrates the hooks of the plugin.
	 */
